...
from pruning import Pruning, RandomVar
import time

class CooccurPruning(Pruning):
    ...
    def __init__(self, session,
        ...
        less than k values
        """
        super(CooccurPruning, self).__init__(session)
                ...
                if self.cellvalues[tuple_id][cell_index].dirty == 1:
                    ...
                    if self.cellvalues[tuple_id][cell_index].domain == 1:
                        ...
                        self.v_id_dk_list.append([(
                                    self.cellvalues[tuple_id][cell_index].tupleid +1),
                    ...
                    if self.cellvalues[tuple_id][cell_index].domain == 1:
                        if len(self.cell_domain[tmp_cell_index]) > 1:
                            ...
                            self.v_id_clean_list.append([
                                ...
                                self.cellvalues[tuple_id][cell_index].columnname, tmp_cell_index])
                            ...
                            domain_kij_clean.append([
                                ...
                                self.cellvalues[tuple_id][cell_index].columnname, k_ij])
