...
data = spark.read.csv("../../../datasets/hospital1k/hospital_dataset.csv", header=True, encoding='utf-8')
out_path = "../../../datasets/hospital1k/hospital_dataset_norm.csv"
...
columns = ["ProviderNumber", "HospitalName","Address1","Address2","Address3","City","State","ZipCode","CountyName","PhoneNumber", "HospitalType","HospitalOwner","EmergencyService","Condition","MeasureCode","MeasureName","Score","Sample","Stateavg"]
